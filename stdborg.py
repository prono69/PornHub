...
if len(Config.SUDO_USERS) == 0:
    logging.warning("'SUDO_USERS' should have atleast one value")
    sys.exit(1)
...
if Config.HU_STRING_SESSION is not None:
    ...
    container = AlchemySessionContainer(engine=Config.DB_URI)
    ...
    if Config.TG_BOT_TOKEN_BF_HER:
        ...
        temp_borg = TelegramClient(
            "temp_bot_session", api_id=Config.APP_ID, api_hash=Config.API_HASH
        ...
        logging.info(f"please send /start to your '@{Config.TG_BOT_USER_NAME_BF_HER}'")
